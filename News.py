...
"""
# Bro News: The best way to read your news
"""
st.markdown("_Welcome to QuickNews, the fastest way to summarize articles and news reports!_")

# Set the URL that you want to make a request to.
article_url = st.text_input("_Enter an article's URL:_")
st.markdown("_Created by Brendan Arias_")
